...
type Video struct {
	...
	ShareCount    int64      `thrift:"share_count,9" frugal:"9,default,i64" json:"share_count"`
}
...
func (p *Video) writeField9(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("share_count", thrift.I64, 9); err != nil {
		goto WriteFieldBeginError
	}
...
func (p *Video) DeepEqual(ano *Video) bool {
	...
	if !p.Field9DeepEqual(ano.ShareCount) {
		return false
	}
	return true
}
...
func (p *PublishActionRequest) GetUserName() (v string) {
	return p.UserName
}
...
func (p *PublishActionRequest) SetUserName(val string) {
	p.UserName = val
}
